...
def mute_monitors(pause_duration_hours: int, client_name: str):
    """
...
def unmute_monitors(client_name: str):
    """
...
if __name__ == "__main__":
    ...
    if args.action == "mute":
        mute_monitors(args.duration, args.client_name)
    elif args.action == "unmute":
        unmute_monitors(args.client_name)

# To run the script:
# export DATADOG_API_KEY=your_api_key
# export DATADOG_APP_KEY=your_app_key
# python mute_monitor.py mute "Client" --duration 4
# python mute_monitor.py unmute "Client"